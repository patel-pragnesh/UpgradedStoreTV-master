...
using IMediaPicker = MediaPickerSample.IMediaPicker;
using MediaPickerArgs = MediaPickerSample.MediaPickerArgs;
using MediaPickerErrorArgs = MediaPickerSample.MediaPickerErrorArgs;
...
namespace XLabs.Platform.Services.Media
{
	...
	///     Class MediaPicker.
	/// </summary>
	public class MediaPickerdroid : IMediaPicker
	{
